        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formUser" name="formUser">
                    ...
                    <input class="form-control" id="txtNome" name="txtNome" type="text" placeholder="Nome del usuario" required>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="password" class="form-control validPass" id="clave" name="clave" placeholder="Senha">
                    </div>
                    <div class="form-group">
